...
for label in inproc-hset tcp-hset-std inproc-get tcp-get-std inproc-set tcp-set-std tcp-get-pipe tcp-hset-pipe tcp-mixed-getset-pipe tcp-mixed-gethset-pipe tcp-mixed-getset-std; do
