...
This summary pairs the diagnosis-pass findings (in `bench/results/fix-issues-23-24/profiles/diagnosis-baseline/SUMMARY.md`) with the measured impact of the two fixes that landed before any of the four planned `command-flow-optimization` child plans started.
...
Profile evidence from `bench/results/fix-issues-23-24/profiles/diagnosis-baseline/cpu/inproc-hset.prof`:
...
- `bench/results/fix-issues-23-24/profiles/diagnosis-baseline/cpu/inproc-hset.prof` + `.top.txt` — the profile that surfaced the bug
- `bench/results/fix-issues-23-24/profiles/diagnosis-baseline/SUMMARY.md` — full diagnosis writeup
